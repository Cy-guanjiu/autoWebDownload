...
# __browser_url = r'C:\Users\guanjiu\AppData\Roaming\360se6\Application\360se.exe'  ##360浏览器的地址
...
def verification_code():  # 识别验证码,返回验证码
    ...
    image = 'image/yzm.png'
    imageobject = Image.open(image)  # 打开验证码图片
    # 图片进行置灰处理
